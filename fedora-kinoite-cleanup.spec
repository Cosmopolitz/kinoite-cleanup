Name:           fedora-kinoite-cleanup
Version:        1.4
Release:        1%{?dist}.cosmo
Summary:        Automated cleanup utilities for Fedora Kinoite
License:        MIT

Source:         kinoite-cleanup-cosmo-%{version}.tar.gz

BuildArch:      noarch
Requires:       /usr/bin/bash

%description
Cleanup scripts for Fedora Kinoite including rpm-ostree cleanup, Flatpak cleanup,
log cleanup and temporary file maintenance.
...
%changelog
* Wed Nov 19 2025 Cosmopolitz <none> - 1.4-1
- Automated GitHub build version
